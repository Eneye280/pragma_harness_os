...
export function TourOverlay({ state, steps, onChange }: TourOverlayProps): React.ReactElement | null {
  ...
  return (
    ...
    >
      <p className="text-[10px] font-semibold uppercase tracking-[0.16em] text-harness-soft">
      ...
      <div className="mt-3 flex items-center gap-2">
        <button
          ...
          className="rounded-control border border-hairline px-2 py-1 text-[11px] text-zinc-400 hover:bg-zinc-800"
        >
          Saltar paso
        </button>
        <button
